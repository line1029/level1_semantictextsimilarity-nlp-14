...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', default=folder_path+'/data/dev_pred_input_size_12.csv')
    parser.add_argument('--dev_path', default=folder_path+'/data/dev_pred_input_size_12.csv')
    parser.add_argument('--test_path', default=folder_path+'/data/dev_pred_input_size_12.csv')
    parser.add_argument('--predict_path', default=folder_path+'/data/test_pred_input_size_12.csv')
    ...
    candidates_paths = ['blending_val_pearson=0.9454-v1.ckpt',
                       'blending_val_pearson=0.9454-v2.ckpt',
                       'blending_val_pearson=0.9454-v3.ckpt']
    
    for path in candidates_paths:
        model = BlendingEnsembleModel.load_from_checkpoint(folder_path + "/code/230418_001_ensemble_sweep/save/" + path)
        torch.save(model, folder_path + "/code/230418_001_ensemble_sweep/save/" + path[:-4] + "pt")