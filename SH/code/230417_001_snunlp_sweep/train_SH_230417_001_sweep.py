...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default=folder_path+'/data/train_resampled_swap_v2.csv')
    ...
    parser.add_argument('--project_name', default="STS_snunlp_krelectra_disc_001")
    ...
    def sweep_train(config=None):
        ...
        wandb_logger = WandbLogger(project=args.project_name, name=f"robertasmall_bs48_lr{config.learning_rate}_me{config.max_epoch}_MSE_{args.run_name}")
