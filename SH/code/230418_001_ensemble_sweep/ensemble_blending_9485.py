...
if __name__ == '__main__':
    ...
    sweep_config = {
        ...
        'parameters': {
            ...
            'learning_rate':{
                'values': [1e-5, 5e-5, 1e-4, 5e-4, 1e-3, 5e-3, 1e-2, 5e-2, 1e-1],
            },
            'max_epoch':{
                'values': [3, 5, 10, 20, 30]
            },
    ...
    def sweep_train(config=None):
        ...
        wandb_logger = WandbLogger(project=args.project_name,
                                   name=f'Blending_is12_lr{config.learning_rate}_hs{config.hidden_size}lf_{config.loss_func}_bs{config.batch_size}',
