...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='./save/snunlp_0006_val_pearson=0.9309.ckpt', type=str)
    ...
    output.to_csv(f'snunlp_0006_val_pearson=0.9309.csv', index=False)
