...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', default="JS")
    parser.add_argument('--project_name', default="STS_klue_rl_resampled_sweep_JS")
    ...
    sweep_id = wandb.sweep(
        ...
        entity="boostcamp-sts-14"   # entity의 이름을 추가합니다.
    )
    wandb.agent(
